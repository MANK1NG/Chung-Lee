...
export default class LogrosScene extends Phaser.Scene{
    ...
    create(){
        ...
        else if(this.logros.onlyKusaP1) {
        ...
        else if(this.logros.onlyTanegashimaP1) {
        ...
        else if(this.logros.onlyKusaP2) {
        ...
        else if(this.logros.onlyTanegashimaP2) 
        {
